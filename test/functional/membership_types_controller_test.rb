...
class MembershipTypesControllerTest < ActionController::TestCase
  ...
  test "should create membership_type" do
    assert_difference('MembershipType.count') do
      post :create, membership_type: { become_lapsed: @membership_type.become_lapsed, become_nonfinancial: @membership_type.become_nonfinancial, description: @membership_type.description, name: @membership_type.name }
    end
  ...
  test "should update membership_type" do
    put :update, id: @membership_type, membership_type: { become_lapsed: @membership_type.become_lapsed, become_nonfinancial: @membership_type.become_nonfinancial, description: @membership_type.description, name: @membership_type.name }
    assert_redirected_to membership_type_path(assigns(:membership_type))
  end
